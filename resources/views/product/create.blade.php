        ...
        <div class="container-fluid">
            ...
            <div class="row">
              <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <select class="tags" name="tags[]" multiple="multiple" data-placeholder="Добавьте теги" style="width: 100%;">
                    @foreach($tags as $tag)
                ...
                <div class="form-group">
                  <select class="colors" name="colors[]" multiple="multiple" data-placeholder="Добавьте цвет" style="width: 100%;">
